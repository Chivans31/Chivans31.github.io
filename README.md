...
### 1. NHS Paediatric Risk Intelligence Platform 🏥
...
- **Tech Stack**: Programming (Python), Data Science (Pandas, NumPy, Scikit-Learn, XGBoost), Explainable AI (SHAP), MLOps (MLflow, Docker, GitHub Actions), Backend (FastAPI, Uvicorn), Frontend (Render, Streamlit Cloud), Reporting (Power BI), Data Engineering (PySpark, Databricks-ready architecture).
...
### 3. Football Scout AI: Undervalued Player Detection ⚽
...
### 4. Sentiment Analysis for Football Player Valuation
...
### 5. Food Image Classification: Deep Learning Benchmark 🍕
...
### 6. Predictive Car Price Valuation 🚗
- **Description**: An ensemble-based regression project using AutoTrader datasets to predict vehicle resale values, utilizing advanced feature engineering and target encoding to handle high-cardinality categorical data.
